...
@section('content')
    ...
    {{-- Header Banner (SAMA DENGAN USER) --}}
        ...
        <div class="stats-grid-modern">
            <div class="stat-card-modern">
                ...
                <div class="stat-content">
                    <div class="stat-value-modern" data-count="{{ $jumlahTotalPasien ?? 0 }}">0</div>
            ...
            <div class="stat-card-modern">
                ...
                <div class="stat-content">
                    <div class="stat-value-modern" data-count="{{ $jumlahMenunggu ?? 0 }}">0</div>
                    ...
                    <div class="card-body-modern">
                        <div class="info-row tips-row">
                            ...
                            <div class="info-text">
                                ...
                                <span class="value">{{ $jumlahSelesai ?? 0 }} Pasien sudah ditangani ✅</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    * { 
    ...
    /* ===== STATS SECTION (SAMA DENGAN USER) ===== */
    .stats-section {
        margin-bottom: 40px;
    ...
    /* ===== SCHEDULE SECTION (SAMA DENGAN USER) ===== */
    .schedule-section {
        margin-bottom: 30px;
    ...
    .dark-mode .status-diperiksa-awal {
